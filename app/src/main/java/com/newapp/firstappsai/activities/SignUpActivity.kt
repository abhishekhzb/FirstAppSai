...
abstract class SignUpActivity : AppCompatActivity() {
     abstract var userName_et: EditText
     abstract var phone_et: EditText
     abstract var email_et: EditText
     abstract var password_et: EditText
     abstract var signUpButton: Button
